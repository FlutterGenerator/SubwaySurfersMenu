...
public class FloatingModMenuService extends Service {
  ...
  private void initFloating() {
    ...
    try {
      this.open = getAssets().open("Photoa.png");
    } catch (IOException e) {
      e.printStackTrace();
      this.open = (InputStream) null;
    }
    mExpanded.setBackground(Drawable.createFromStream(this.open, (String) null));
    ...
    */
    ...
    title.setTypeface(Typeface.createFromAsset(getAssets(), "MK.ttf"));
    ...
    hideBtn.setTypeface(Typeface.createFromAsset(getAssets(), "ar.ttf"));
    hideBtn.setOnClickListener(
        new View.OnClickListener() {
          public void onClick(View view) {
            ...
            Toast.makeText(
                    view.getContext(),
                    "Icon hidden. Remember the hidden icon position LONG CLICK TO KILL SERVICE",
                    Toast.LENGTH_LONG)
                .show();
          }
        });
    ...
    closeBtn.setTypeface(Typeface.createFromAsset(getAssets(), "ar.ttf"));
  ...
  private View Switch(final int featNum, final String featName, boolean swiOn) {
    ...
    final android.graphics.drawable.GradientDrawable GD_THUMB =
        new android.graphics.drawable.GradientDrawable();
    GD_THUMB.setSize(28, 28);
    GD_THUMB.setShape(1);
    GD_THUMB.setStroke(3, Color.parseColor("#FFFFFF"));
    GD_THUMB.setColor(Color.parseColor("#FF000000"));

    final android.graphics.drawable.GradientDrawable GD_TRACK =
        new android.graphics.drawable.GradientDrawable();
    GD_TRACK.setSize(25, 5);
    GD_TRACK.setCornerRadius(100);
    GD_TRACK.setStroke(3, Color.parseColor("#FFFFFF"));
    GD_TRACK.setColor(Color.parseColor("#00000000"));

    final Switch switchR = new Switch(this);
    switchR.setText(featName);
    switchR.setTextColor(TEXT_COLOR_2);
    switchR.setTypeface(Typeface.createFromAsset(getAssets(), "ex.ttf"));
  ...
  private View ButtonLink(final String featName, final String url) {
    ...
    button.setAllCaps(false); // Disable caps to support html
    button.setTextColor(TEXT_COLOR_2);
    button.setTypeface(Typeface.createFromAsset(getAssets(), "MK4.ttf"));
    button.setText(Html.fromHtml(featName, Html.FROM_HTML_MODE_LEGACY));
    button.setBackgroundColor(BTN_COLOR);
    button.setOnClickListener(
        new View.OnClickListener() {
